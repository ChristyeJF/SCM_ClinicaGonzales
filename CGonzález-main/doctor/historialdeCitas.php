...
{ ?>
	...
	<a href="historialdeCitas.php?id=<?php echo $row['id']?>&cancel=update" onClick="return confirm('¿Está seguro de que desea cancelar esta cita?')"class="btn btn-transparent btn-xs tooltips" title="Cancel Appointment" tooltip-placement="top" tooltip="Remove">Cancel</a>
	<?php } else {
