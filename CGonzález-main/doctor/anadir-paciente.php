...
if($sql)
{
echo "<script>alert('Información del paciente añadida correctamente');</script>";
...
<textarea type="text" name="medhis" class="form-control"  placeholder="Ingrese el historial médico del paciente (si existe)" required="true"></textarea>
</div>	
