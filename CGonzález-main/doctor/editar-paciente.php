...
header('location:gestionar-pacientes.php');
...
<div class="form-group">
              ...
              <input type="radio" name="gender" id="gender" value="male">Hombre
              <?php } else { ?>
              <label>
              <input type="radio" name="gender" id="gender" value="Male" checked="true">Hombre
