...
if($sql)
{
echo "<script>alert('Datos del médico actualizados correctamente');</script>";
...
<html lang="en">
	<head>
		<title>Doctor | Editar Datos del Doctor</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Doctor | Editar Datos del Doctor</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Doctor</span>
									...
									<li class="active">
										<span>Editar Datos del Doctor</span>
									</li>
								</ol>
							</div>
						</section>
...
{
?>
<h4>Perfil <?php echo htmlentities($data['doctorName']);?></h4>
