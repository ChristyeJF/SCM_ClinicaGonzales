...
{
?>
<h4>Perfil <?php echo htmlentities($data['fullName']);?></h4>
<p><b>Fecha del registro del perfil: </b><?php echo htmlentities($data['regDate']);?></p>
...
<div class="form-group">
					...
					<a href="cambiar-emaild.php">Actualice su dirección de correo electrónico</a>
														</div>
