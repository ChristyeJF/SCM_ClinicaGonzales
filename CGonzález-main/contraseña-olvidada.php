...
header('location:restablecer-contrasena.php');
} else {
echo "<script>alert('Datos no válidos. Por favor, inténtelo con datos válidos');</script>";
echo "<script>window.location.href ='contraseña-olvidada.php'</script>";
	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.html"><h2> Clínica González | Recuperación de contraseña de paciente</h2></a>
				</div>
				...
				<div class="box-login">
					<form class="form-login" method="post">
						<fieldset>
							...
							<p>
								Por favor, introduzca su Email y contraseña para recuperar su contraseña.<br />
					...
					<div class="copyright">
						&copy; <span class="current-year"></span><span class="text-bold text-uppercase"> Clínica González</span>. <span>Todos los derechos reservados</span>
					</div>
