...
<html lang="en">
	<head>
		<title>Administrador | Gestionar Doctores</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Administrador | Gestionar Doctores</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
...
?>
	...
	<a href="gestionar-doctores.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('¿Seguro que quieres borrar?')"class="btn btn-transparent btn-xs tooltips" tooltip-placement="top" tooltip="Remove"><i class="fa fa-times fa fa-white"></i></a>
												</div>
