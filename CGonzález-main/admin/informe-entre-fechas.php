...
<html lang="en">
	<head>
		<title>Administrador | Reportes de datos</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Reportes | entre Fechas</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Informes entre fechas</span>
									</li>
									<li class="active">
										<span>Reportes</span>
									</li>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												...
												<div class="panel-body">
													...
													<form role="form" method="post" action="entredatos-detallesinformes.php">
