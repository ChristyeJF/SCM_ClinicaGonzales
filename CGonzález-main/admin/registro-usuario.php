...
<html lang="en">
	<head>
		<title>Administrador | Registros de sesiones del usuario</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Administrador | Registros de sesiones del usuario</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
									...
									<li class="active">
										<span>Registros de sesiones del usuario</span>
									</li>
								</ol>
							</div>
						</section>
