...
if($sql)
{
$msg="Datos del médico actualizados correctamente";
...
<html lang="en">
	<head>
		<title>Administrador | Editar Datos del Doctor</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Administrador | Editar Datos del Doctor</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
