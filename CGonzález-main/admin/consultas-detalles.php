...
if($query){
echo "<script>alert('Admin Remark actualizado con éxito.');</script>";
echo "<script>window.location.href ='consultas-leidas.php'</script>";
}
		  }
?>
<!DOCTYPE html>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<div class="container-fluid container-fullw bg-white">
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15">Gestión <span class="text-bold">Detalles de la consulta</span></h5>
